...
import getDisplayVersionsForProductController from "./getDisplayVersionsForProductController";
...
app.use(
  "/get-display-versions-for-product",
  getDisplayVersionsForProductController
);
